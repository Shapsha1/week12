...
const makeTwo = () => {
    const num1 = 20;
    const num2 = 7;
    resultTwo.textContent = Math.abs(num1 - num2);
    //Ваш код
};
...
const makeFive = () => {
    const num = 3;
    const power = 4;
    resultFive.textContent = Math.pow(num, power); //Ваш код
};
...
const makeSix = () => {
    const num1 = 20;
    const num2 = 5;
    resultSix.textContent = num1 / num2; //Ваш код
...
const makeSeven = () => {
    const num1 = 25;
    const num2 = 7;
    resultSeven.textContent = num1 % num2; //Ваш код
};
...
const makeEleven = () => {
    num1 = 5;
    num2 = 2;
    resultEleven.textContent = num1 % num2;
    //Ваш код
};
...
const makeEighteen = () => {
    ...
    const strNew = str.replace("world", "JavaScript");
...
const makeTwentyOne = () => {
    resultTwentyOne.textContent = Math.ceil(Math.random() * 10);
    //Ваш код
};
...
const makeTwentySix = () => {
    ...
    resultTwentySix.textContent = randomNumber.toFixed(4); //Ваш код
};
...
const makeTwentySeven = () => {
    resultTwentySeven.textContent = Math.floor(50 + Math.random() * 51); //Ваш код
};
...
const makeTwentyEight = () => {
    const num = 4.47;
    resultTwentyEight.textContent = Math.ceil(num);
    //Ваш код
};
...
const makeThirty = () => {
    const num = 25;
    resultThirty.textContent = Math.sqrt(num);
    //Ваш код
};
